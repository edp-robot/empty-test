...
**Homepage:** <https://github.com/epmd-edp/java-gradle-java8.git>
...
* <https://github.com/epmd-edp/java-gradle-java8.git>
...
| framework | string | `"java8"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"empty-test"` |  |
